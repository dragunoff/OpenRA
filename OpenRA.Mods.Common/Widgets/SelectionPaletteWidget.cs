...
namespace OpenRA.Mods.Common.Widgets
{
	...
	public class SelectionPaletteWidget : Widget
	{
		...
		public override bool HandleKeyPress(KeyInput e)
		{
			...
			var modifiers = e.Modifiers.HasModifier(Modifiers.Shift) ? Modifiers.Shift : Modifiers.None;
			...
			return toSelect != null ? HandleEvent(toSelect, MouseButton.Left, modifiers) : false;
		}
